...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(CELL_INSERT, marginTop, self.backgroundView.width, self.backgroundView.height - marginTop * 2) collectionViewLayout:layout];
